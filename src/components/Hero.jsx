...
const Hero = () => {
  const words = ["Full Stack Developer",  "Tech Enthusiast", "Innovating for Impact"];
      ...
      <div className="flex flex-wrap">
        ...
        <div className="w-full lg:w-1/2 lg:p-8">
          <div className="flex justify-center">
            <motion.img
              className="rounded-2xl mt-4 max-w-xs lg:max-w-md w-full object-cover"
