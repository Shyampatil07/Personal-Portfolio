...
export const EXPERIENCES = [
  {
    year: "2022 - 2026",
    image: SRTTC,
    role: "BE - Artificial Intelligence and Data Science & Engineering",
    company: "Suman Ramesh Tulsiani Technical Campus Faculty of Engineering",
    description: `Pursuing a Bachelor of Engineering (BE) in Artificial Intelligence and Data Science at Suman Ramesh Tulsiani Technical Campus, Pune, with a current GPA of 7.10/10.00 (Absolute). Currently in the final year, I am honing my skills in software development, an active member of Google Developer Student Clubs.`,
  ...
  },
  {
    ...
    company: "ASM Group of Institutes, Pimpri-Chinchwad",
    description: `Achieved an impressive 64.50% overall, with Computer Science as a key subject, and diligently studied Physics, Chemistry, Mathematics, Biology, and Information Technology showcasing a robust academic foundation and a strong commitment to academic excellence.`,
    technologies: [],
  },
  {
    year: "2018 - 2020",
    ...
    company: "SMC English School, Washim",
    description: `With a strong focus on both Science and Mathematics, I earned an impressive 75.00% in my board exams, showcasing a deep understanding of key subjects and reflecting exceptional academic dedication and achievement.`,
    technologies: [],
  },
];
...
export const CONTACT = {
  ...
  phoneNo: "+91 8010599962 ",
  email: "shyamlade06@gmail.com",
};
